...
2. CONFIRMED NEGATIVES: Edges with q_eq < alpha (confirmed no connection)
   - These are edges with strong evidence of no functional connection
...
This is the labeling policy used when evaluating against the functional atlas.
...
def create_leifer_labels(
    ...
    # These edges have strong evidence of no functional connection.
