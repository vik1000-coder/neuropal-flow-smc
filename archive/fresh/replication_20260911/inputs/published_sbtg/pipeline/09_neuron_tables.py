...
def generate_phase_tables():
    ...
    for phase_key, phase_label in phases.items():
        ...
        # Phase-specific results do not contain mu_hat coupling strengths;
        # use sign_adj counts directly.
...
def generate_cook_leifer_evaluation_table():
    ...
    with open(md_file, 'w') as f:
        ...
        f.write("Evaluation of SBTG connectivity graphs against reference networks:\n\n")
