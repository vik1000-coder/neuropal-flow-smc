...
Theory:
    ...
    The analysis segments time series into states and compares SBTG coupling strengths
...
def load_traces_from_prepared_data(dataset: str = "full_traces_imputed") -> Tuple[List[np.ndarray], List[str]]:
    ...
    for split in ['train', 'test']:
        ...
        if split_file.exists():
            data = np.load(split_file, allow_pickle=False)
...
def main():
    ...
    sig_mask = data[f'significant_lag{args.lag}'].astype(bool)
