...
Unified evaluation of SBTG and baseline methods against reference networks:
...
def align_matrices(
    ...
    """
    Align a score matrix to a reference matrix by finding common neurons.
...
def evaluate_vs_binary(
    ...
    """
    Evaluate connectivity scores against a binary reference network.
...
def main():
    ...
    parser.add_argument('--against', choices=['cook', 'leifer', 'both'], 
                        default='both', help='Reference network to evaluate against')
