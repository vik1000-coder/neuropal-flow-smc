...
Centralizes shared constants and hyperparameters for the SBTG pipeline.
"""
...
# =============================================================================
# A 50-trial comparison found that the DSM-loss optimum did not maximize the
# Cook-reference AUROC. The defaults below retain the better-performing
# feature-bilinear setting and avoid the overfitting observed at L1=1e-5.
