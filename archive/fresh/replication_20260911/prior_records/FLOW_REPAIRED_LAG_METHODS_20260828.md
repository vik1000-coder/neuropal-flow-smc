...
This is the dated **E26 mathematical four-sampler specification**. Its consolidated results are in the [E26 technical report](results/four_sampler_lag_connectome_20260828/analysis/PROGRESSIVE_BRIDGE_SMC_TECHNICAL_REPORT.md). For the later, larger atlas and calibrated inference, use the [E27/E29 atlas](results/neural_prediction_atlas_20260829/README.md); for the current synthesis, sourced class summaries, and 54-versus-80 provenance, use the [31 August E31 report](results/neuron_class_effects_20260831/README.md). Those later reports adjudicate current claims without rewriting the historical numbers below.
